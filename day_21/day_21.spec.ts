...
test("kabaddi",async({page})=>{
    ...
    let match = await page.locator('(//div[@class="fixtures-element"])[1]//div[@class="element element1" or @class="element element2" or @class="element element3"]').allTextContents();
    for(let i of match){
        console.log(i);
        console.log("");
    }
